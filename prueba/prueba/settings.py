...
SECRET_KEY = 'django-insecure-x)^xnxt^+h#&=g^mg5%dn*z+s=n6(e37+&kr$@wmx9sz@4d0v+'
...
CKEDITOR_CONFIGS = {
    ...
    'toolbar_Custom': [
        ...
        ['NumberedList', 'BulletedListe', '-', 'Outdent', 'Indent', '-','JustifyLeft', 'JustifyCenter', 'JustifyBlock'],
        ['Link', 'Unlink'],
        ['RemoveFormat', 'Source']
    ]
    }
